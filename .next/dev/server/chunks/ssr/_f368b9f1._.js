module.exports = [
"[project]/src/app/(dashboard)/bank-soal/[id]/pdf-viewer.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
// We'll dynamically import react-pdf and pdfjs on the client to avoid server-side evaluation
// that can throw (DOMMatrix missing, worker mismatches, etc.).
let _workerObjectUrl = null;
async function ensurePdfWorker(pdfjs) {
    // Prefer a local bundled worker first (more reliable)
    try {
        const localUrl = '/pdf.worker.min.js';
        console.debug('Checking local worker at', localUrl);
        ...
        if (localRes.ok) {
            ...
            try {
                if (pdfjs?.GlobalWorkerOptions) pdfjs.GlobalWorkerOptions.disableWorker = false;
            } catch (e) {}
            console.debug('Using local pdf.worker:', localUrl);
            return;
        }
    } catch (e) {
        console.debug('Local worker not available:', e);
    }
    // Try a few CDN strategies to obtain a worker script that matches the runtime pdfjs version.
    const tryUrls = [];
    const version = pdfjs?.version;
    if (version) tryUrls.push(`https://cdnjs.cloudflare.com/ajax/libs/pdf.js/${version}/pdf.worker.min.js`);
    // fallback known stable versions
    tryUrls.push("https://cdnjs.cloudflare.com/ajax/libs/pdf.js/5.4.296/pdf.worker.min.js");
    tryUrls.push("https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.16.105/pdf.worker.min.js");
    for (const cdnUrl of tryUrls){
        try {
            console.debug("Attempting to fetch pdf.worker from:", cdnUrl);
            const res = await fetch(cdnUrl);
            if (!res.ok) {
                console.debug("Worker fetch returned non-ok status", res.status, cdnUrl);
                continue;
            }
            ...
            if (_workerObjectUrl) URL.revokeObjectURL(_workerObjectUrl);
            _workerObjectUrl = URL.createObjectURL(blob);
            pdfjs.GlobalWorkerOptions.workerSrc = _workerObjectUrl;
            try {
                if (pdfjs?.GlobalWorkerOptions) pdfjs.GlobalWorkerOptions.disableWorker = false;
            } catch (e) {}
            console.debug("pdf.worker loaded via blob URL from", cdnUrl);
            return;
        } catch (err) {
            console.debug("Failed to fetch worker from", cdnUrl, err);
        // try next
        }
    }
    // If we reach here, all fetch attempts failed. Disable worker mode safely.
    console.error("Failed to set up pdf.worker from CDN; falling back to disabled worker mode");
    try {
        if (pdfjs?.GlobalWorkerOptions) pdfjs.GlobalWorkerOptions.disableWorker = true;
        else pdfjs.disableWorker = true;
        console.debug("pdfjs worker disabled; using main-thread parsing fallback");
    } catch (e) {
        console.error("Failed to disable pdfjs worker:", e);
    }
}
function PDFViewer({ fileUrl }) {
    ...
    const [fullData, setFullData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isFetchingFallback, setIsFetchingFallback] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    // Dynamic react-pdf / pdfjs module objects
    const [reactPdf, setReactPdf] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [pdfjsModule, setPdfjsModule] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (async ()=>{
            try {
                const mod = await __turbopack_context__.A("[project]/node_modules/react-pdf/dist/index.js [app-ssr] (ecmascript, async loader)");
                const pdfjs = await (()=>{
                    const e = new Error("Cannot find module 'pdfjs-dist/build/pdf'");
                ...
                // setup worker after we have pdfjs
                await ensurePdfWorker(pdfjs);
            } catch (err) {
                console.error("Failed to dynamically import react-pdf/pdfjs:", err);
    ...
    async function handleLoadError(err) {
        ...
        setError(String(err?.message || err));
        // Try fallback: fetch the full file as ArrayBuffer and pass to react-pdf
        if (isFetchingFallback || fullData) return;
        try {
            ...
            setError(null);
            setIsLoading(true);
        // react-pdf will try again automatically when `file` prop changes
        } catch (e) {
    ...
    const DocumentComp = reactPdf?.Document ?? null;
    const PageComp = reactPdf?.Page ?? null;
        ...
        children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chevron$2d$left$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__ChevronLeft$3e$__["ChevronLeft"], {
                                    ...
                                    fileName: "[project]/src/app/(dashboard)/bank-soal/[id]/pdf-viewer.tsx",
                                    lineNumber: 153,
                                    columnNumber: 13
                                }, this)
                            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                    className: "h-8 w-8 animate-spin text-amber-500 mx-auto mb-2"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/(dashboard)/bank-soal/[id]/pdf-viewer.tsx",
                                    lineNumber: 174,
                                    columnNumber: 15
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "w-full flex justify-center p-6 bg-white",
                        children: DocumentComp && PageComp ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(DocumentComp, {
                            file: fullData ? {
                                data: fullData
                            } : fileUrl,
                            ...
                            loading: null,
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(PageComp, {
                    ...
                    error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            isFetchingFallback ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-xs text-gray-500",
                                children: "Mencoba fallback download..."
                            }, void 0, false, {
                                fileName: "[project]/src/app/(dashboard)/bank-soal/[id]/pdf-viewer.tsx",
                                lineNumber: 198,
                                columnNumber: 35
...
//# sourceMappingURL=_f368b9f1._.js.map